    ...
    return (
      <div className="rounded-[28px] border border-dashed border-border bg-card p-12 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Cadastre o primeiro item para começar a organizar seus produtos e abrir os detalhes de cada um em um modal.
        </p>
      </div>
    );
  }
            ...
            <CardContent className="p-5">
              ...
              <div className="mt-4 rounded-2xl border border-border/70 bg-background/80 p-3">
                ...
                <p className="mt-2 text-sm font-medium text-foreground">
                  {hasReservation ? formatInventoryCalendarDate(item.deadline) : "Não definida"}
                </p>
