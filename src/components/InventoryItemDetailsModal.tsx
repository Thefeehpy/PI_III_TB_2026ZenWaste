...
import { ArrowDownRight, ArrowUpRight, CalendarClock, Clock3, Package2, Target } from "lucide-react";
        ...
        <div className="space-y-6 p-6">
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-[24px] border border-border/70 bg-card p-4">
              ...
              <p className="mt-3 text-2xl font-semibold text-foreground">{formatInventoryCalendarDate(item.deadline)}</p>
            </div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Ajuste a quantidade reservada e o prazo diretamente neste modal.
                    </p>
                  </div>
