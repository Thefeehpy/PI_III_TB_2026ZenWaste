...
export default function BolsaPage() {
  ...
  const getTrendIcon = (change: number) => {
    if (change > 0) return <TrendingUp className="h-4 w-4 text-blue-600 dark:text-blue-400" />
      ...
      <div className="mx-auto max-w-7xl px-4 py-6">
        ...
        <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/30">
            <CardHeader className="pb-2">
              <CardDescription className="text-blue-700 dark:text-blue-300">Maior Alta</CardDescription>
              <CardTitle className="text-xl text-blue-700 dark:text-blue-200">
                {topGainers[0]?.name}
          ...
          <Card className="border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-900/30">
            <CardHeader className="pb-2">
              <CardDescription className="text-red-600 dark:text-red-400">Maior Baixa</CardDescription>
              <CardTitle className="text-xl text-red-600 dark:text-red-300">
                {topLosers[0]?.name}
                <span className="ml-2 text-sm font-normal">
